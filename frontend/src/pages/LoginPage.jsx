...
import { ArrowRight, Loader, Lock, LogIn, Mail, User } from "lucide-react";
      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm
                            ...
                            focus:ring-offset-2 focus:ring-emerald-500 transition duration-150 ease-in-out disable:opacity-50"
              disabled={loading}
            >
              {loading ? (
                <>
          ...
          <p className="mt-8 text-center text-gray-400">
            ...
            <Link
              to="/signup"
              className="underline text-emerald-400 hover:text-emerald-500 transition duration-150 ease-in-out"
            >
              Sign up
            </Link>
          </p>
