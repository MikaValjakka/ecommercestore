        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                <ShoppingCart className="inline-block mr-1 group-hover:rotate-20 transition-all duration-300 text-emerald-400 size={20}" />
            ...
            {user ? (
              <button
                className="bg-gray-700 hover:gb-gray-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out"
                onClick={logout}
              >
                <LogOut size={18} />
