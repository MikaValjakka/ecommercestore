...
function CreateProductForm() {
  ...
  // destructure createProduct and loading from useProductStore
  ...
  // image is changed to base64 string
  ...
  return (
    <motion.div
      className="bg-gray-800 shadow-ls rounded-lg p-8 mb-8 max-w-xl mx-auto"
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label
            htmlFor="name"
            className="bloack text-sm font-medium text-gray-300"
          >
            Product Name
          </label>
          <input
            ...
            className="mt-1 bloack w-full bg-gray-700 border border-gray-600 rounded-md shadow-sm py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
          />
        </div>
        <div>
          <label
